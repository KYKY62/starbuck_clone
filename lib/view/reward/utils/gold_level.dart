...
class GoldLevel extends StatelessWidget {
  const GoldLevel({super.key});
                ...
                child: Column(
                  children: [
                    ...
                    RewardsRuleUtils(
                      totalstar: "- 200 Stars",
                      rewardsdescription:
                          "= Free selected Starbucks Core Whole Bean",
                    ),
                    SizedBox(height: 50.0),
                    RewardsRuleUtils(
                      totalstar: "- 400 Stars",
                      rewardsdescription: "25% Off for selected Merchandise",
                    ),
                    SizedBox(height: 50.0),
                  ],
                ),
